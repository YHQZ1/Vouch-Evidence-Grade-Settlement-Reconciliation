...
describe('integer currency formatting', () => {
  ...
  it('keeps arbitrarily large monetary strings exact with BigInt', () => {
    expect(formatCalculatedValue('signed_net_subunits', '900719925474099312345')).toBe(
      'INR 90,07,19,92,54,74,09,93,123.45',
    );
    expect(() => formatCalculatedValue('signed_net_subunits', '12.5')).toThrow(
